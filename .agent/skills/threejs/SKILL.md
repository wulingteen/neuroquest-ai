---
name: threejs
description: Build 3D web apps with Three.js (WebGL/WebGPU). **Only use for building 3D scenes, animations, custom shaders, PBR materials, VR/XR experiences, games, data visualizations, product configurators on the App.**
---
