    ...
    return (
        <div className="min-h-screen px-4 py-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-end justify-center gap-3 mb-8">
                ...
                {/* 1st */}
                <div className="flex flex-col items-center">
                    <div className="glass-card p-4 text-center border border-yellow-500/40 mb-2 w-36 neon-glow-gold">
                ...
                {leaderboard.map((entry, idx) => {
                    ...
                    return (
                        <div
                            key={entry.rank}
                            className={cn(
                                "glass-card p-4 flex items-center gap-4 border",
                                isMe
            ...
            <div className="mt-6 glass-card p-5 border border-blue-500/20 bg-blue-500/5">
